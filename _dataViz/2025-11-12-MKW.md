...
Now, the [hiplot](https://facebookresearch.github.io/hiplot/) framework is quirky and a bit obscure in its documentation so I couldn't get any custom color palette to work but here are some snapshots of the [exported HTML](https://github.com/Chipdelmal/MKW_ParallelPlot/blob/main/plots/parallel.html), which can be readily [downloaded](https://github.com/Chipdelmal/MKW_ParallelPlot/blob/main/plots/parallel.html) and run in any browser (click on the image for a live version):


<center><a href='https://chipdelmal.github.io/media/mkw/parallel.html'><img width="100%" src="/media/mkw/select03.png"></a></center>
