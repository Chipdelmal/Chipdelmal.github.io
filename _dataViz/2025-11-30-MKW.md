...
I won't go into much detail on the UI, as I am not a particularly good UI developer and plan to improve it a bit here and there if time allows, but all the code can be found [here](https://github.com/Chipdelmal/MKW_ParallelPlot/blob/main/radar.py).
...
* Apps: DashUI, [HiPlot](https://chipdelmal.github.io/media/mkw/parallel.html)
