...
In most cases, the migration probability between sites is calculated with a kernel that is a function of the distance between sites $$\kappa$$, and some biological parameters $$\rho$$.
