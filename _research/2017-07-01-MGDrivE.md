...
* It can be installed and used directly in [R](https://www.r-project.org/about.html) through [CRAN](https://cran.r-project.org/web/packages/MGDrivE/index.html): even though we internally use a [C++](https://www.cplusplus.com/) version for speed purposes, the original package was developed in [R](https://www.r-project.org/about.html) for accessibility purposes
...
One strong component of these visualizations has been the generation of videos showing the results predicted by our simulations in spatial contexts, which can be found in our [MGDrivE youtube playlist](https://youtube.com/playlist?list=PLRzY6w7pvIWqFJi94ZfhPkSVnazlUylpN):
