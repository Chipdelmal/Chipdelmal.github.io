...
Creating and shipping the materials for the webinars is a bit complicated the first couple of times and requires some setup so that it's not more of a pain than strictly necessary. In general, doing our docker-packaged webinars involved the following steps:
